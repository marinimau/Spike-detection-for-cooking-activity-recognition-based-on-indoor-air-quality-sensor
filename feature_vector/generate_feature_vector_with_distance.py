...
#   Author: Mauro Marini
#   Project: tesi
#   feature_vector/generate_feature_vector_with_distance.py
#
...
class DistanceCompleteFeatureVectorGenerator:
        ...
        with open('feature_vector_results/complete_feature_vector.csv', mode='w') as feature_vector_file:
            ...
            results_writer.writerow(
                ['datetime', 'n_co2_peaks_last5', 'n_co2_peaks_next5', 'n_co2_peaks_last10',
                 ...
                 'avg_humidity_last30m', 'avg_humidity_next30m', 'actual_humidity', 'min_dist_co2', 'min_dist_tvoc',
            ...
            with open('feature_vector_results/complete_feature_vector.csv', mode='a+') as feature_vector_file:
                ...
                results_writer.writerow(
                    [day_data.datetime[i], co2_count_last5, co2_count_next5,
                     ...
                     avg_hum_next25m, avg_hum_last30m, avg_hum_next30m, actual_hum, min_dist_co2, min_dist_tvoc,
                     min_dist_pm25, min_dist_temp, min_dist_hum, pasto])
        return
