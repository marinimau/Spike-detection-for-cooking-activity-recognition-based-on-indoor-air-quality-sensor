...
#   Author: Mauro Marini
#   Project: tesi
#   feature_vector/generate_peaks_features.py
#
...
class PeaksFeatureVectorGenerator:
    ...
    def init_csv_file(self, sensor):
        if sensor == 0:
            ...
            name = 'peaks_features_results/peaks_feature_{}.csv'.format(sensor)
    ...
    def print_feature(self, sensor, co2_p, tvoc_p, pm25_p, temp_p, hum_p, day_data):
        for i in range(len(day_data.datetime)):
            ...
            with open('peaks_features_results/peaks_feature_{}.csv'.format(sensor), mode='a+') as single_feature_vector_file:
