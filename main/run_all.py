...
class Run_all:
    ...
    def run(self, SENSOR, DAY, use_avg, draw_chart, n_peaks_co2_to_find, n_peaks_tvoc_to_find, n_peaks_pm25_to_find, max_num_intervals):
        ...
        if len(day_data.datetime) == len(day_data.is_pasto) and draw_chart:
            ...
            plt.plot(day_data.datetime,
                     ad_data.mul(pm25, 20))  # moltiplico solo per rendere visibili le variazioni nel grafico
